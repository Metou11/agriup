...
<form action="/poivron" method="post" class="section">
    <div class="d-flex align-items-start">
        ...
        <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                <div><img src="image/poivron2.jpg" class="rounded mx-auto d-block" alt="..." width="1300" height="500"></div>
                <div>

                    <p>
                    <h4>• la plante</h4><br>

                    La culture des piments doux (poivrons) est très importante au Sénégal.
